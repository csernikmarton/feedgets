            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo-horizontal class="block h-9 w-auto" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        <x-nav-link :href="route('feeds.manage')" :active="request()->routeIs('feeds.manage')" wire:navigate>
                            {{ __('Manage Feeds') }}
                        </x-nav-link>
                    @endauth
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 space-x-2">
                ...
                @else
                    <div class="space-x-2">
                        ...
                        <a href="{{ route('register') }}" class="text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100">{{ __('Register') }}</a>
                    </div>
                @endauth
            </div>

            <div class="-me-2 flex items-center sm:hidden">
                <x-theme-switcher class="mr-2" />
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                <x-responsive-nav-link :href="route('feeds.manage')" :active="request()->routeIs('feeds.manage')">
                    {{ __('Manage Feeds') }}
                </x-responsive-nav-link>
            @endauth
