...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'The Feedgets v1 JSON API. Authenticate with a Sanctum personal access token (`Authorization: Bearer <token>`); tokens are issued via `/api/v1/auth/login` or the Settings → API Tokens screen.',
    ],
